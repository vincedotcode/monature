...
const sendContactEmail = async (contactData) => {
  ...
  const msg = {
    to: process.env.CONTACT_EMAIL, // Your email where the contact form submissions will be sent
    from: process.env.FROM_EMAIL, // The email address you verified in SendGrid
